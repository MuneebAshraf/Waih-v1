...
js_audioPlayer(7,"audio/23:02-2017.mp3", "Vært: Elias Rama<br>Emne: Forbydelse af bederum, en løsning eller symbolpolitik?<br>Gæst: Safia Aoude");
js_audioPlayer(6,"audio/02-03-2017.mp3", "Vært: Elias Rama<br>Emner: Bederum & Forholdet mellem politikere og borgere<br>Gæster: Madhiha Shafiqi & Tore Lindvang");
js_audioPlayer(5,"audio/09-03-2017.mp3", "Vært: Lamies Nassri<br>Emne: Amanah Rådgivning,<br>en telefonisk rådgivningslinje for unge muslimer<br>Gæster: Safiya Abu Laban & Yara Issa");
js_audioPlayer(4,"audio/16-03-2017.mp3", "Vært: Elias Rama<br>Emne: EU-dommen for fyring på baggrund af religiøse symboler<br>Gæst: Tore Lindvang");
js_audioPlayer(3,"audio/23-03-2017.mp3",  "Vært: Elias Rama<br>Emne: Har danske muslimer særlige udfordringer med integration?<br>Gæst: Abdelkarim Khamal");
js_audioPlayer(2,"audio/30-03-2017.mp3",  "Vært: Elias Rama<br>Emne: Er troen på gud et minus på CV'et<br>Gæst: Omar El-khatib");
js_audioPlayer(1,"audio/06-04-2017.mp3",  "Vært: Elias Rama<br>Emne: Kemisk angreb i Syrien<br>Gæster: Bilal Abdul Kareem og Khalid Al Subeihi");
