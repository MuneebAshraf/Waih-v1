...
function latestPodcasts() {
    ...
    function monday() {
        var apropos ="<div class='col-md-6 col-sm-6 wp3 senestePodcasts'>"+"<div class='overlay-effect effects'>"+"<div class='img col-md-4'>"+"<a href='#' onclick="+"MM_openBrWindow('apropos-lyd.html','','resizable=yes,width=540,height=300')"+" class='expand'>"+"<div class='overlay'><i class='ion-ios-play-outline'></i></div>"+"<img src='img/test.jpeg' alt='Portfolio Item'>"+"</a>"+"</div>"+"</div>"+"<p class='PodcastHeader col-md-8'>Apropos</p>"+"<div id='aproposPlayerText1' class='infoText'></div>"+"</div>";
