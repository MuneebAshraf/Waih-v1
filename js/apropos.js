...
js_audioPlayer(9,"audio/03:02-2017.mp3","Vært: Zainab Nasrati<br>Emne: Empati<br>Gæst: Ali Nicolaisen");
js_audioPlayer(8,"audio/10:02-2017.mp3", "Vært: Lubna Ahmed<br>Emne: Tonen i den offentlige debat<br>Gæst: Digter og debattør, Özcan Ajrulovski");
js_audioPlayer(7,"audio/17:02-2017.mp3",  "Vært:Zainab Nasrati<br>Emne: Mindfulnessog den muslimske bøn <br>Gæst: Sprogpsykolog og mentor Hamida Naji");
js_audioPlayer(6,"audio/24:02-2017.mp3",  "Vært: Aysha Farooqui<br>Emne: Uddannelsespres <br>Gæst: Jeannett Skov");
js_audioPlayer(5,"audio/03-03-201.mp3", "Vært: Zainab Nasrati<br>Emne: Drømme for Danmark...<br>Gæster: Caroline Ousager & Osama Samsam ");
js_audioPlayer(4,"audio/10-03-2017.mp3", "Værter: Aysha Farooqui og Elias Rama<br>Emne: Nike's hijab, inklusion eller kapitalisering?<br>Gæster: Zarife Øzcan, Karima Doui og Laila Kristensen Rashid");
js_audioPlayer(3,"audio/17-03-2017.mp3", "Værter: Elias Rama<br>Emne: Old School vs. New School<br>Gæste: Imran Shah");
js_audioPlayer(2,"audio/24-03-2017.mp3",  "Værter: Zainab Nasrati<br>Emne: Studiets ruter<br>Gæste: Samya Adnan & Mikkel Zacho Storm");
js_audioPlayer(1,"audio/31-03-2017.mp3",  "Værter: Aysha Farooqui<br>Emne: Kropsidealer, skønhed og selvtillid blandt danske unge<br>Gæste:  Amina Djondjorova & Arshia Arshad");
    ...
    $.ajax({
        ...
        success: function()
        {
            $("#player"+location).append(
                ...
                "</div>"+
                "</div>");
            $("#aproposPlayerText"+location).append(
                "<div id='jquery_jplayer_"+location+"' class=jp-jplayer'></div>");
